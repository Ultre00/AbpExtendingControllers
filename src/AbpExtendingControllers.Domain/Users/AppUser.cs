...
namespace AbpExtendingControllers.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpExtendingControllersDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpExtendingControllersEfCoreEntityExtensionMappings to extend the IdentityUser entity
