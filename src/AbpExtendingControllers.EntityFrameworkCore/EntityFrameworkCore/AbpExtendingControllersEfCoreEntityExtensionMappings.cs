...
{
    public static class AbpExtendingControllersEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AbpExtendingControllersModuleExtensionConfigurator CLASS (in the Domain.Shared project)
